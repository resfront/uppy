...
module.exports = function Dashboard(props) {
  ...
  }, props.i18n('closeModal'), props.i18n('closeModal'), props.hideModal, closeIcon(), props.hideModal, props.inline && props.maxWidth ? 'max-width: ' + props.maxWidth + 'px;' : '', props.inline && props.maxHeight ? 'max-height: ' + props.maxHeight + 'px;' : '', Tabs({
    files: props.files,
